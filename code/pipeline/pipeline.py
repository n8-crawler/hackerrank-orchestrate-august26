...
graph.add_node("context", build_context_node, retry_policy=retry_policy)
graph.add_node("image", image_analyse_node, retry_policy=retry_policy)
graph.add_node("voice", voice_analysis_node, retry_policy=retry_policy)
graph.add_node("prompt", build_prompt_node, retry_policy=retry_policy)
graph.add_node("reason", build_response_node,retry_policy=retry_policy)
graph.add_node("parser", parser_node,retry_policy=retry_policy)
